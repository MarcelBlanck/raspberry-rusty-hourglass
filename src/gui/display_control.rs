...
mod tests {
    ...
    #[test]
    fn test_draw_boxes() {
        let check_rect = |display: &DisplayBuffer,
                          x0: isize,
                          y0: isize,
                          x1: isize,
                          y1: isize,
         ...
         -> bool {
            ...
            for x in bottom_left.x..(top_right.x + 1) {
                ...
                if display
                    .get_pixel_color(&Point { x, y: top_right.y })
                    .unwrap()
                    .ne(border_color)
                {
                    return false;
            ...
            for y in (bottom_left.y + 1)..top_right.y {
                ...
                if display
                    .get_pixel_color(&Point { x: top_right.x, y })
                    .unwrap()
                    .ne(border_color)
                {
                    return false;
